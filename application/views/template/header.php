...
<head>
  ...
  <title><?= $this->config->item('app') ?> <?= date("Y"); ?> || <?= $this->config->item('owner') ?> <?= $this->config->item('domisili_mini') ?></title>
  <link rel="shortcut icon" href="<?= base_url('assets/yys.png'); ?>" type="image/x-icon">
